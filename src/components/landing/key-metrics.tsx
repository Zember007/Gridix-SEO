  ...
  const metrics: Feature[] = [
    {
      ...
      content: (
        <div className="text-center">
          <div className="text-4xl font-bold text-gray-900 mb-2">{t('keyMetrics.leadCost.reduction')}</div>
          <div className="text-sm text-gray-500 mb-3">{t('keyMetrics.leadCost.reductionText')}</div>
    ...
    },
    {
      ...
      content: (
        <div className="text-center">
          ...
          <div className="text-5xl font-bold text-gray-900 mb-2">{t('keyMetrics.conversion.new')}</div>
          <div className="inline-block px-4 py-2 bg-blue-100 text-blue-700  rounded-full text-sm font-bold">
    ...
    },
    {
      ...
      content: (
        <div className="text-center">
          <div className="text-4xl font-bold text-gray-900 mb-2">{t('keyMetrics.processingSpeed.savings')}</div>
          <div className="text-sm text-gray-500 mb-3">{t('keyMetrics.processingSpeed.savingsText')}</div>
          <div className="inline-block px-4 py-2 bg-blue-100 text-blue-700  rounded-full text-sm font-bold">
