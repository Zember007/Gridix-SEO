        ...
        >
          ...
          <motion.div variants={itemVariants} className="flex flex-col justify-center">
            <div className="space-y-6">
              ...
              {subtitle && (
                <p className="text-xl text-gray-600 max-w-[500px]   leading-relaxed">
                  {subtitle}
                </p>
              )}
              ...
              <div className="flex items-center gap-3 pt-4">
                {testimonials.map((_, index) => (
                  <button
                    ...
                    className={`h-2.5 rounded-full transition-all duration-300 ${activeIndex === index ? "w-10 bg-primary" : "w-2.5 bg-muted-foreground/30"
                      }`}
